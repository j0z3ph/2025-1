...
namespace HolaMundo.Controllers {
    ...
    public class CustomersController : Controller {
        ...
        public async Task<IActionResult> Create([Bind("CustomerId,FirstName,MiddleInitial,LastName")] Customer customer) {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("CustomerId,FirstName,MiddleInitial,LastName")] Customer customer) {
